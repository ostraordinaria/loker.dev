        ...
        <div className="dark:border-trueGray-700 mt-5 grid w-full max-w-screen-2xl grid-cols-1 gap-10 border-t border-gray-100 pt-10 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 max-w-md text-gray-500 dark:text-gray-400">
              Through our innovative approach, we aim to simplify and optimize
              the entire job-seeking process, fostering meaningful connections
              between developers and recruiters while facilitating efficient and
